...
const CONTENT = {
  ...
  en: {
    ...
    highlights: [
      ...
      { icon: RotateCcw, title: "30 days", text: "To return unsealed records." },
    ...
    sections: [
      ...
      { h: "Returns", p: ["You have 30 days from delivery to return any unsealed record, provided it keeps its original condition. If the return is due to our mistake or a record that doesn't match the description, we cover the costs and offer an exchange or full refund.", "To start a return, write to us from the contact page with your order number and we'll guide you through the process."] },
