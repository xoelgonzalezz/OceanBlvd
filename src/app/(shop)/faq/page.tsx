...
const FAQS_ES = [
  ...
  { q: "¿Cuánto tarda el envío?", a: "Los pedidos se entregan normalmente en unos 5 días laborables dentro de la península. El envío es gratuito a partir de 60 € y cuesta 4,99 € por debajo de ese importe." },
...
const FAQS_EN = [
  ...
  { q: "How long does shipping take?", a: "Orders are usually delivered within about 5 working days in mainland Spain. Shipping is free over €60 and costs €4.99 below that amount." },
